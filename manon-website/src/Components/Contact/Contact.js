        ...
        {switchLanguage ? (
          <>
            <p className="paragraph">
              Vous pouvez me contacter via <FaLinkedinIn color="gold" />, ou via
              l'adresse suivante:{" "}
              <b style={{ color: "gold" }}>abelcoindozm@gmail.com</b> ou alors
            ...
            <p className="paragraph">
              ...
              <span className="linkedin">
                ...
                >
                  <FaLinkedinIn
                    size={30}
                    style={{ marginLeft: "05px", marginRight: "05px" }}
                  />
                </a>
              </span>
              , or here: <b style={{ color: "gold" }}>abelcoindozm@gmail.com</b>{" "}
